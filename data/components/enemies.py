...
from ..types import Vector2, Entity, State, State_Machine, Rectangle
from .. import sprites
from .. import sounds
...
class Goomba(Entity):
    ...
    class Animation:
        ...
        def move_anim(self):
            ...
            self.anim_timer += c.var_time
            if self.anim_timer > 14 * c.var_time:
                self.anim_frame += 1
                self.anim_timer = 0
        ...
        def squish_delay(self):
            ...
            self.anim_timer += c.var_time
            if self.anim_timer > 20 * c.var_time:
    ...
    class Run_State(State):
        ...
        def update(self, owner_object):
            owner_object.animation.move_anim()
...
class Turtle(Entity):
    ...
    class Animation():
        ...
        def move_anim(self):
            ...
            self.anim_timer += c.var_time
            if self.anim_timer > 13 * c.var_time:
                self.anim_frame += 1
                self.anim_timer = 0
    ...
    class Move_Shell(State):
        ...
        def update(self, owner_object):
            self.can_kill_timer += c.var_time
            if self.can_kill_timer > 10 * c.var_time:
